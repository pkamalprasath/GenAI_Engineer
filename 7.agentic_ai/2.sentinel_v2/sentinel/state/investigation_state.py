...
class InvestigationState(TypedDict):
    ...
    applicant_data: Optional[dict]  # Structured applicant/case data for analysis
    ...
    # ── Legal agent ToolNode message thread (Phase 2C) ────────────────────
    # LangChain message objects for tool-call loop (separate from plain dict 'messages')
    legal_messages: Annotated[list[AnyMessage], add_messages]
